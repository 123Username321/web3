 ...
 */
final class Version20200512222052 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedbacks (id INT NOT NULL, content VARCHAR(255) NOT NULL, raiting INT NOT NULL, add_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
