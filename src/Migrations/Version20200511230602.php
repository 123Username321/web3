 ...
 */
final class Version20200511230602 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedbacks (id INT NOT NULL, user_id INT NOT NULL, prod_id INT NOT NULL, content VARCHAR(255) NOT NULL, raiting DOUBLE PRECISION NOT NULL, add_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
