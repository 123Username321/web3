 ...
 */
final class Version20200512193428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE feedbacks (id INT NOT NULL, product_id_id INT NOT NULL, user_id_id INT NOT NULL, content VARCHAR(255) NOT NULL, raiting DOUBLE PRECISION NOT NULL, add_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
